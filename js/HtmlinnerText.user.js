...
style.innerHTML = 'textarea,pre{margin:0;padding:0;outline:0;border:0;}.expandingArea{z-index:999;position:relative;border:1px solid#fff;background:#fff;}.expandingArea>textarea,.expandingArea>pre{padding:5px;background:transparent;font:400 12px/15px helvetica,arial,sans-serif;white-space:pre-wrap;word-wrap:break-word;}.expandingArea>textarea{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;-ms-box-sizing:border-box;box-sizing:border-box;width:100%;height:100px;}.expandingArea.active>textarea{overflow:hidden;position:absolute;top:0;left:0;height:100%;resize:none;}.expandingArea>pre{display:none;}.expandingArea.active>pre{display:block;visibility:hidden;}';
...
document.querySelector('.expandingArea textarea').value = '<!--⡞完整源码⡞-->\r\n' + text;
